...
for fold, (train_idx, val_idx) in enumerate(kf.split(all_image_npy_paths)):
    ...
    for epoch in range(config.EPOCHS):
        ...
        for images, masks in train_loader:
            ...
            loss = loss_function.hausdorff_bce_dice_loss(outputs, masks)
        ...
        with torch.no_grad():
            ...
            print("Training iou: {:.4f}, Validation iou: {:.4f}, Traning dice: {:.4f}, Validation dice: {:.4f}, Traning precision {:.4f}, Validation precision: {:.4f}, Traning specificity: {:.4f}, Validation specificity: {:.4f}".format(train_iou, val_iou, train_dice, val_dice,  train_precision, val_precision, train_specificity, val_specificity))
...
plt.title("Training & Validation Recall/ Sensitivity on Dataset")
plt.xlabel("Epoch #")
